...
set output "./plots/AF_XXX/S=1_2/iTEBD/mpslen=2/D=16/seed=10/tensor.gif"
sta(i) = sprintf("snapshots/AF_XXX/S=1_2/iTEBD/mpslen=2/D=16/seed=10/A/%d.dat", i)
stb(i) = sprintf("snapshots/AF_XXX/S=1_2/iTEBD/mpslen=2/D=16/seed=10/B/%d.dat", i)
bwab(i) = sprintf("snapshots/AF_XXX/S=1_2/iTEBD/mpslen=2/D=16/seed=10/AB/%d.dat", i)
bwba(i) = sprintf("snapshots/AF_XXX/S=1_2/iTEBD/mpslen=2/D=16/seed=10/BA/%d.dat", i)
